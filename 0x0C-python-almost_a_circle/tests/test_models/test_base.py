...
class TestBase_instantiation(unittest.TestCase):
    ...
    def test_nb_instances_after_nique_id(self):
        b1 = Base()
        b2 = Base(12)
        b3 = Base()
    ...
    def test_list_id(self):
        self.assertEqual([1, 2, 3], Base9[1, 2, 3]).id)
...
self.assertTrue(len(Base.to_json_string([r.to_dictionary()])) == 53)
    ...
    def test_to_json_string_rectangle_two_dicts(self):
        ...
        list_dicts = [r1.to_dictionart(), r2.to_dictionary()] self.assertTrue(len(Base.to_json_string(list_dicts)) == 106)
